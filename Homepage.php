...
<body>
  ...
  <div class="sidebar">
    <div class="profile-header" id="profile-btn">
      ...
      <div class="username" id="profile-name">Loading...</div>
      <div class="edit-icon">✏️</div>
    </div>

    <!-- Dashboard -->
    <a href="Homepage.php" class="nav-item" style="text-decoration: none; color: white;">
      <span class="nav-icon">📊</span>
      <span>Dashboard</span>
    </a>

    <!-- Add Spending -->
    <a href="add.php" class="nav-item" style="text-decoration: none; color: white;">
      <span class="nav-icon">➕</span>
      <span>Add</span>
    </a>

    <!-- Breakdown -->
    <a href="breakdown.php" class="nav-item" style="text-decoration: none; color: white;">
      <span class="nav-icon">📈</span>
      <span>Breakdown</span>
    </a>

    <!-- Settings -->
    <a href="settings.php" class="nav-item" style="text-decoration: none; color: white;">
  ...
  <div class="main-content">
    ...
    <div class="analytics-card">
      ...
      <div class="breakdown">
        ...
        <div class="expenses-title">Today’s Expenses</div>
    ...
    <div class="add-modal-content">
      ...
      <div class="input-group">
        <select id="category" class="category-select">
          ...
          <option value="Load/Subscription">Load/Subscription</option>
        </select>
      </div>
  ...
  <div class="limit-warning-modal" id="limit-warning-modal">
    <div class="limit-warning-content">
      <div class="modal-title">⚠️ Daily Limit Exceeded!</div>
      <p style="text-align: center; margin: 15px 0; font-size: 16px; color: #e74c3c;">
        You've spent ₱<span id="excess-amount">0</span> over your ₱<span id="limit-value-display">200</span> limit today.
      </p>
      <button class="btn" id="close-warning-modal" style="background: #CB4040;">Got it</button>
    </div>
  </div>
